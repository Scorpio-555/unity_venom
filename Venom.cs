...
public class Venom : MonoBehaviour
{
    ...
    void CheckToMove()
    {
        ...
        {
            if (Input.GetButtonDown("Up") && aerial == false)
            {
                aerial = true;
                standing = false;
        ...
        if (crawling)
        {
            if (crawl_position == "Right Wall")
            {
                ...
                if (Input.GetButton("Left") && aerial == false)
                {
                    pos.x = pos.x - 0.5f;
                    if (facing_left == false)
                    {
            ...
            if (crawl_position == "Left Wall")
            {
                ...
                if (Input.GetButton("Right") && aerial == false)
                {
                    pos.x = pos.x + 0.5f;
            ...
            if (crawl_position == "Ceiling")
            {
                ...
                if (Input.GetButton("Down") && aerial == false)
                {
                    if (facing_left)
                    {
                        pos.x = pos.x + 0.7f;
